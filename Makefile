...
windows: lint
	env CGO_ENABLED=1 GOOS=windows GOARCH=amd64 GOGARBLE=github.com/jpillora/chisel garble -tiny -literals build -trimpath ${LDFLAGS} ${GCFLAGS} ${ASMFLAGS} -o ${DIR}/chisel-windows_amd64 .
